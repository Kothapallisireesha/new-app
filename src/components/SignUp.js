    ...
    return (
        <div>
            ...
            <div className="mb-3">
                    ...
                    />
                {emailError&&<div className="errMsg" style={{color:"red",float:"left"}}>{emailError}</div>}
                </div>
                <div className="mb-3">
                    <input
                    name="Name"
                    ...
                    onChange={(event)=>{updateUserData(event)}}
                    />
                {nameError&&<div className="errMsg" style={{color:"red",float:"left"}}>{nameError}</div>}
                </div>
                <div className="mb-3">
                    <input
                    name="password"
                    ...
                    onChange={(event)=>{updateUserData(event)}}
                    />
                {pwdError&&<div className="errMsg" style={{color:"red",float:"left"}}>{pwdError}</div>}
                </div>
                <div className="mb-3">
                    <input
                    name="password"
